      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h3 className="text-lg font-bold mb-6 flex items-center gap-2">
            <TrendingDown className="text-blue-500" /> Frecuencia de Fallas por
            Categoría
          </h3>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h3 className="text-lg font-bold mb-6 flex items-center gap-2">
            <AlertCircle className="text-red-500" /> Modelos Críticos Detectados
          </h3>
          <div className="space-y-4">
            {faultStats.slice(0, 5).map((stat: any, index: number) => (
              <div
                key={index}
                ...
                <div className="text-right">
                  ...
                  <div className="w-24 bg-gray-200 h-1.5 rounded-full mt-1">
                    <div
                      ...
                      style={{
                        width: `${(stat.occurrences / faultStats[0].occurrences) * 100}%`,
                      }}
                    ></div>
                  </div>
                </div>
